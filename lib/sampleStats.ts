...
export function sampleStatsFromCurrentSummary(input: SummaryJson): StatsInput {
  ...
  const empleoMuestra = total > 0
    ? {
        ...
        totalFormalesMin: formales,
        totalFormalesMax: formales,
        totalFormalesPunto: formales,
        totalInformalesMin: informales,
        totalInformalesMax: informales,
        totalInformalesPunto: informales,
        totalMujeresMin: Math.round(vinculadas * 0.55),
        totalMujeresMax: Math.round(vinculadas * 0.55),
        totalMujeresPunto: Math.round(vinculadas * 0.55),
        totalJovenesMin: Math.round(vinculadas * 0.3),
        totalJovenesMax: Math.round(vinculadas * 0.3),
        totalJovenesPunto: Math.round(vinculadas * 0.3),
        totalMayores60Min: Math.round(vinculadas * 0.05),
        totalMayores60Max: Math.round(vinculadas * 0.05),
        totalMayores60Punto: Math.round(vinculadas * 0.05),
        totalDiversidadMin: Math.round(vinculadas * 0.02),
        totalDiversidadMax: Math.round(vinculadas * 0.02),
        totalDiversidadPunto: Math.round(vinculadas * 0.02),
        totalPersonasVinculadasMin: vinculadas,
        totalPersonasVinculadasMax: vinculadas,
        totalPersonasVinculadasPunto: vinculadas,
        ...
        validosPersonasVinculadas: total,
      }
    : {
        totalFormales: 0,
        totalInformales: 0,
